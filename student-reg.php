...
?>
          <form action="" method="post" enctype="multipart/form-data" class="pt-5 pb-5">
            ...
            <fieldset>
              ...
              <table align="center" class="table-striped table-responsive" cellpadding="12"
      ...
      ?>
                ...
                <tr>
                  ...
                  <td>Gender</td>
                  <td><input type="radio" name="gender" value="male" checked="checked">Male &nbsp;<input type="radio"
